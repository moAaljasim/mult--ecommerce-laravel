@extends('frontend.master_dasboard')
   @section('main')
       @include('frontend.home.home_slide')
       <!-- End hero slider -->
       @include('frontend.home.home_feautre')
       ...
       @include('frontend.home.home_banner')
        ...
        @include('frontend.home.home_newProduct')

        <!--Products Tabs-->

        @include('frontend.home.home_feautrproduct')
  ...
  @include('frontend.home.home_vendorList')
